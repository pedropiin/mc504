 ...
 36c:	89 d1                	mov    %edx,%ecx
{
 ...
 399:	0f b6 92 d0 0f 00 00 	movzbl 0xfd0(%edx),%edx
 ...
 419:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 489:	ff 24 85 78 0f 00 00 	jmp    *0xf78(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 597:	90                   	nop
          s = "(null)";
 598:	ba 6f 0f 00 00       	mov    $0xf6f,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5b1:	a1 b0 15 00 00       	mov    0x15b0,%eax
{
 ...
 5f1:	5b                   	pop    %ebx
  freep = p;
 5f2:	89 15 b0 15 00 00    	mov    %edx,0x15b0
}
 5f8:	5e                   	pop    %esi
 5f9:	5f                   	pop    %edi
 5fa:	5d                   	pop    %ebp
 ...
 629:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 62c:	89 15 b0 15 00 00    	mov    %edx,0x15b0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 649:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 64c:	8b 3d b0 15 00 00    	mov    0x15b0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 68f:	73 4f                	jae    6e0 <malloc+0xa0>
    ...
    if(p == freep)
 691:	8b 3d b0 15 00 00    	mov    0x15b0,%edi
 ...
 6ba:	e8 f1 fe ff ff       	call   5b0 <free>
  return freep;
 6bf:	8b 15 b0 15 00 00    	mov    0x15b0,%edx
 ...
 6ec:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 6ef:	89 15 b0 15 00 00    	mov    %edx,0x15b0
}
 ...
 6ff:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 700:	c7 05 b0 15 00 00 b4 	movl   $0x15b4,0x15b0
 707:	15 00 00 
    base.s.size = 0;
 70a:	bf b4 15 00 00       	mov    $0x15b4,%edi
    base.s.ptr = freep = prevp = &base;
 70f:	c7 05 b4 15 00 00 b4 	movl   $0x15b4,0x15b4
 716:	15 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 719:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 71b:	c7 05 b8 15 00 00 00 	movl   $0x0,0x15b8
 722:	00 00 00 
    if(p->s.size >= nunits){
...
int random()
{
 ...
 a10:	69 0d ac 15 00 00 0d 	imul   $0x19660d,0x15ac,%ecx
 a17:	66 19 00 
 ...
 a3f:	a3 ac 15 00 00       	mov    %eax,0x15ac
    return seed;
 a44:	c3                   	ret    
...
int permute_line(char file_path[]) {
 ...
 c40:	68 2c 10 00 00       	push   $0x102c
 c45:	6a 01                	push   $0x1
...
int add_line(char *file_path, char *new_line) {
 ...
 d49:	68 68 10 00 00       	push   $0x1068
 d4e:	6a 01                	push   $0x1
 ...
 d62:	68 8c 10 00 00       	push   $0x108c
 d67:	6a 01                	push   $0x1
...
int write_random_string(char file_path[]) {
 ...
 de0:	be b0 10 00 00       	mov    $0x10b0,%esi
int write_random_string(char file_path[]) {
 de5:	53                   	push   %ebx
        int idx_new_char = random() % size_char_set;
...
void io_bound(char file_path[]) {
 ...
 eab:	68 08 11 00 00       	push   $0x1108
 eb0:	6a 01                	push   $0x1
