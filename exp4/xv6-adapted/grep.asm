...
000001d0 <grep>:
{
 ...
 1fd:	50                   	push   %eax
 1fe:	8d 81 60 12 00 00    	lea    0x1260(%ecx),%eax
 204:	50                   	push   %eax
 ...
 21b:	8b 4d dc             	mov    -0x24(%ebp),%ecx
    p = buf;
 21e:	c7 45 e4 60 12 00 00 	movl   $0x1260,-0x1c(%ebp)
    buf[m] = '\0';
 225:	c6 81 60 12 00 00 00 	movb   $0x0,0x1260(%ecx)
    while((q = strchr(p, '\n')) != 0){
 ...
 2bb:	81 fa 60 12 00 00    	cmp    $0x1260,%edx
 ...
 2d0:	83 ec 04             	sub    $0x4,%esp
      m -= p - buf;
 2d3:	2d 60 12 00 00       	sub    $0x1260,%eax
 2d8:	29 c1                	sub    %eax,%ecx
      memmove(buf, p, m);
 2da:	51                   	push   %ecx
 2db:	52                   	push   %edx
 2dc:	68 60 12 00 00       	push   $0x1260
      m -= p - buf;
 ...
 67c:	89 d1                	mov    %edx,%ecx
{
 ...
 6a9:	0f b6 92 f0 0d 00 00 	movzbl 0xdf0(%edx),%edx
 ...
 729:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 799:	ff 24 85 98 0d 00 00 	jmp    *0xd98(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 8a7:	90                   	nop
          s = "(null)";
 8a8:	ba 8e 0d 00 00       	mov    $0xd8e,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 8c1:	a1 60 16 00 00       	mov    0x1660,%eax
{
 ...
 901:	5b                   	pop    %ebx
  freep = p;
 902:	89 15 60 16 00 00    	mov    %edx,0x1660
}
 908:	5e                   	pop    %esi
 909:	5f                   	pop    %edi
 90a:	5d                   	pop    %ebp
 ...
 939:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 93c:	89 15 60 16 00 00    	mov    %edx,0x1660
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 959:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 95c:	8b 3d 60 16 00 00    	mov    0x1660,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 99f:	73 4f                	jae    9f0 <malloc+0xa0>
    ...
    if(p == freep)
 9a1:	8b 3d 60 16 00 00    	mov    0x1660,%edi
 ...
 9ca:	e8 f1 fe ff ff       	call   8c0 <free>
  return freep;
 9cf:	8b 15 60 16 00 00    	mov    0x1660,%edx
 ...
 9fc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 9ff:	89 15 60 16 00 00    	mov    %edx,0x1660
}
 ...
 a0f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 a10:	c7 05 60 16 00 00 64 	movl   $0x1664,0x1660
 a17:	16 00 00 
    base.s.size = 0;
 a1a:	bf 64 16 00 00       	mov    $0x1664,%edi
    base.s.ptr = freep = prevp = &base;
 a1f:	c7 05 64 16 00 00 64 	movl   $0x1664,0x1664
 a26:	16 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 a29:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 a2b:	c7 05 68 16 00 00 00 	movl   $0x0,0x1668
 a32:	00 00 00 
    if(p->s.size >= nunits){
...
int random()
{
 ...
 d20:	69 0d 4c 12 00 00 0d 	imul   $0x19660d,0x124c,%ecx
 d27:	66 19 00 
 ...
 d4f:	a3 4c 12 00 00       	mov    %eax,0x124c
    return seed;
 d54:	c3                   	ret    
