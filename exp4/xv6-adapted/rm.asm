 ...
 38c:	89 d1                	mov    %edx,%ecx
{
 ...
 3b9:	0f b6 92 f4 0f 00 00 	movzbl 0xff4(%edx),%edx
 ...
 439:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4a9:	ff 24 85 9c 0f 00 00 	jmp    *0xf9c(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5b7:	90                   	nop
          s = "(null)";
 5b8:	ba 95 0f 00 00       	mov    $0xf95,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5d1:	a1 e0 15 00 00       	mov    0x15e0,%eax
{
 ...
 611:	5b                   	pop    %ebx
  freep = p;
 612:	89 15 e0 15 00 00    	mov    %edx,0x15e0
}
 618:	5e                   	pop    %esi
 619:	5f                   	pop    %edi
 61a:	5d                   	pop    %ebp
 ...
 649:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 64c:	89 15 e0 15 00 00    	mov    %edx,0x15e0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 669:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 66c:	8b 3d e0 15 00 00    	mov    0x15e0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6af:	73 4f                	jae    700 <malloc+0xa0>
    ...
    if(p == freep)
 6b1:	8b 3d e0 15 00 00    	mov    0x15e0,%edi
 ...
 6da:	e8 f1 fe ff ff       	call   5d0 <free>
  return freep;
 6df:	8b 15 e0 15 00 00    	mov    0x15e0,%edx
 ...
 70c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 70f:	89 15 e0 15 00 00    	mov    %edx,0x15e0
}
 ...
 71f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 720:	c7 05 e0 15 00 00 e4 	movl   $0x15e4,0x15e0
 727:	15 00 00 
    base.s.size = 0;
 72a:	bf e4 15 00 00       	mov    $0x15e4,%edi
    base.s.ptr = freep = prevp = &base;
 72f:	c7 05 e4 15 00 00 e4 	movl   $0x15e4,0x15e4
 736:	15 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 739:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 73b:	c7 05 e8 15 00 00 00 	movl   $0x0,0x15e8
 742:	00 00 00 
    if(p->s.size >= nunits){
...
int random()
{
 ...
 a30:	69 0d dc 15 00 00 0d 	imul   $0x19660d,0x15dc,%ecx
 a37:	66 19 00 
 ...
 a5f:	a3 dc 15 00 00       	mov    %eax,0x15dc
    return seed;
 a64:	c3                   	ret    
...
int permute_line(char file_path[]) {
 ...
 c47:	68 08 10 00 00       	push   $0x1008
 c4c:	6a 01                	push   $0x1
 ...
 c60:	68 50 10 00 00       	push   $0x1050
 c65:	6a 01                	push   $0x1
...
int add_line(char *file_path, char *new_line) {
 ...
 d69:	68 8c 10 00 00       	push   $0x108c
 d6e:	6a 01                	push   $0x1
 ...
 d82:	68 b0 10 00 00       	push   $0x10b0
 d87:	6a 01                	push   $0x1
...
int write_random_string(char file_path[]) {
 ...
 e00:	be d4 10 00 00       	mov    $0x10d4,%esi
int write_random_string(char file_path[]) {
 e05:	53                   	push   %ebx
        int idx_new_char = random() % size_char_set;
...
void io_bound(char file_path[]) {
 ...
 e73:	56                   	push   %esi
 e74:	8b 75 08             	mov    0x8(%ebp),%esi
 e77:	53                   	push   %ebx
 e78:	bb 64 00 00 00       	mov    $0x64,%ebx
 ...
 e83:	56                   	push   %esi
 e84:	e8 67 ff ff ff       	call   df0 <write_random_string>
    for (int i = 0; i < NUM_STRINGS; i++) {
 e89:	83 c4 10             	add    $0x10,%esp
 e8c:	83 eb 01             	sub    $0x1,%ebx
 e8f:	75 ef                	jne    e80 <io_bound+0x10>
 e91:	bb 32 00 00 00       	mov    $0x32,%ebx
 ...
 ea3:	56                   	push   %esi
 ea4:	e8 c7 fb ff ff       	call   a70 <permute_line>
    for (int i = 0; i < NUM_PERMUT; i++) {
 ea9:	83 c4 10             	add    $0x10,%esp
 eac:	83 eb 01             	sub    $0x1,%ebx
 eaf:	75 ef                	jne    ea0 <io_bound+0x30>
    }

    if (unlink(file_path) != 0) {
 eb1:	83 ec 0c             	sub    $0xc,%esp
 eb4:	56                   	push   %esi
 eb5:	e8 69 f4 ff ff       	call   323 <unlink>
 eba:	83 c4 10             	add    $0x10,%esp
 ebd:	85 c0                	test   %eax,%eax
 ebf:	75 07                	jne    ec8 <io_bound+0x58>
        printf(1,"Error when trying to delete file 'output.txt'\n");
    }
 ec1:	8d 65 f8             	lea    -0x8(%ebp),%esp
 ec4:	5b                   	pop    %ebx
 ec5:	5e                   	pop    %esi
 ec6:	5d                   	pop    %ebp
 ec7:	c3                   	ret    
 ...
 ecb:	68 2c 11 00 00       	push   $0x112c
 ed0:	6a 01                	push   $0x1
 ed2:	e8 59 f5 ff ff       	call   430 <printf>
 ed7:	83 c4 10             	add    $0x10,%esp
 eda:	8d 65 f8             	lea    -0x8(%ebp),%esp
 edd:	5b                   	pop    %ebx
 ede:	5e                   	pop    %esi
 edf:	5d                   	pop    %ebp
 ee0:	c3                   	ret    
 ee1:	66 90                	xchg   %ax,%ax
...
void cpu_bound() {
 ...
 ef4:	56                   	push   %esi
 ef5:	53                   	push   %ebx
 ef6:	8d 84 24 00 90 fd ff 	lea    -0x27000(%esp),%eax
 efd:	81 ec 00 10 00 00    	sub    $0x1000,%esp
 f03:	83 0c 24 00          	orl    $0x0,(%esp)
 f07:	39 c4                	cmp    %eax,%esp
 f09:	75 f2                	jne    efd <cpu_bound+0xd>
 f0b:	81 ec 3c 04 00 00    	sub    $0x43c,%esp
 f11:	be e8 03 00 00       	mov    $0x3e8,%esi
 f16:	8d bd c4 8b fd ff    	lea    -0x2743c(%ebp),%edi
 f1c:	8d 9d e8 8e fd ff    	lea    -0x27118(%ebp),%ebx
 ...
 f2b:	8d 85 c0 8b fd ff    	lea    -0x27440(%ebp),%eax
 f31:	57                   	push   %edi
 f32:	50                   	push   %eax
 f33:	53                   	push   %ebx
 f34:	e8 e7 f9 ff ff       	call   920 <gen_random_digraph>

        int dist[MAX_VERT];
        dijkstra(graph, num_vertices, num_edges, 0, dist);
 f39:	8d 85 c8 8b fd ff    	lea    -0x27438(%ebp),%eax
 f3f:	89 04 24             	mov    %eax,(%esp)
 f42:	6a 00                	push   $0x0
 f44:	ff b5 c4 8b fd ff    	push   -0x2743c(%ebp)
 f4a:	ff b5 c0 8b fd ff    	push   -0x27440(%ebp)
 f50:	53                   	push   %ebx
 f51:	e8 6a f8 ff ff       	call   7c0 <dijkstra>
    for (int i = 0; i < NUM_GRAPHS; i++) {
 f56:	83 c4 20             	add    $0x20,%esp
 f59:	83 ee 01             	sub    $0x1,%esi
 f5c:	75 ca                	jne    f28 <cpu_bound+0x38>
    }
 f5e:	8d 65 f4             	lea    -0xc(%ebp),%esp
 f61:	5b                   	pop    %ebx
 f62:	5e                   	pop    %esi
 f63:	5f                   	pop    %edi
 f64:	5d                   	pop    %ebp
