 ...
 36c:	89 d1                	mov    %edx,%ecx
{
 ...
 399:	0f b6 92 bc 0a 00 00 	movzbl 0xabc(%edx),%edx
 ...
 419:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 489:	ff 24 85 64 0a 00 00 	jmp    *0xa64(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 597:	90                   	nop
          s = "(null)";
 598:	ba 5c 0a 00 00       	mov    $0xa5c,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5b1:	a1 34 0e 00 00       	mov    0xe34,%eax
{
 ...
 5f1:	5b                   	pop    %ebx
  freep = p;
 5f2:	89 15 34 0e 00 00    	mov    %edx,0xe34
}
 5f8:	5e                   	pop    %esi
 5f9:	5f                   	pop    %edi
 5fa:	5d                   	pop    %ebp
 ...
 629:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 62c:	89 15 34 0e 00 00    	mov    %edx,0xe34
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 649:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 64c:	8b 3d 34 0e 00 00    	mov    0xe34,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 68f:	73 4f                	jae    6e0 <malloc+0xa0>
    ...
    if(p == freep)
 691:	8b 3d 34 0e 00 00    	mov    0xe34,%edi
 ...
 6ba:	e8 f1 fe ff ff       	call   5b0 <free>
  return freep;
 6bf:	8b 15 34 0e 00 00    	mov    0xe34,%edx
 ...
 6ec:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 6ef:	89 15 34 0e 00 00    	mov    %edx,0xe34
}
 ...
 6ff:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 700:	c7 05 34 0e 00 00 38 	movl   $0xe38,0xe34
 707:	0e 00 00 
    base.s.size = 0;
 70a:	bf 38 0e 00 00       	mov    $0xe38,%edi
    base.s.ptr = freep = prevp = &base;
 70f:	c7 05 38 0e 00 00 38 	movl   $0xe38,0xe38
 716:	0e 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 719:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 71b:	c7 05 3c 0e 00 00 00 	movl   $0x0,0xe3c
 722:	00 00 00 
    if(p->s.size >= nunits){
...
int random()
{
 ...
 a10:	69 0d 30 0e 00 00 0d 	imul   $0x19660d,0xe30,%ecx
 a17:	66 19 00 
 ...
 a3f:	a3 30 0e 00 00       	mov    %eax,0xe30
    return seed;
 a44:	c3                   	ret    
