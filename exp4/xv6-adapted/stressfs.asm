 ...
 44c:	89 d1                	mov    %edx,%ecx
{
 ...
 479:	0f b6 92 ac 0b 00 00 	movzbl 0xbac(%edx),%edx
 ...
 4f9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 569:	ff 24 85 54 0b 00 00 	jmp    *0xb54(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 677:	90                   	nop
          s = "(null)";
 678:	ba 4b 0b 00 00       	mov    $0xb4b,%edx
        while(*s != 0){
 ...
 691:	a1 24 0f 00 00       	mov    0xf24,%eax
{
 ...
 6d1:	5b                   	pop    %ebx
  freep = p;
 6d2:	89 15 24 0f 00 00    	mov    %edx,0xf24
}
 6d8:	5e                   	pop    %esi
 6d9:	5f                   	pop    %edi
 6da:	5d                   	pop    %ebp
 ...
 709:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 70c:	89 15 24 0f 00 00    	mov    %edx,0xf24
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 729:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 72c:	8b 3d 24 0f 00 00    	mov    0xf24,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 76f:	73 4f                	jae    7c0 <malloc+0xa0>
    ...
    if(p == freep)
 771:	8b 3d 24 0f 00 00    	mov    0xf24,%edi
 ...
 79a:	e8 f1 fe ff ff       	call   690 <free>
  return freep;
 79f:	8b 15 24 0f 00 00    	mov    0xf24,%edx
 ...
 7cc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7cf:	89 15 24 0f 00 00    	mov    %edx,0xf24
}
 ...
 7df:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7e0:	c7 05 24 0f 00 00 28 	movl   $0xf28,0xf24
 7e7:	0f 00 00 
    base.s.size = 0;
 7ea:	bf 28 0f 00 00       	mov    $0xf28,%edi
    base.s.ptr = freep = prevp = &base;
 7ef:	c7 05 28 0f 00 00 28 	movl   $0xf28,0xf28
 7f6:	0f 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7f9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7fb:	c7 05 2c 0f 00 00 00 	movl   $0x0,0xf2c
 802:	00 00 00 
    if(p->s.size >= nunits){
...
int random()
{
 ...
 af0:	69 0d 20 0f 00 00 0d 	imul   $0x19660d,0xf20,%ecx
 af7:	66 19 00 
 ...
 b1f:	a3 20 0f 00 00       	mov    %eax,0xf20
    return seed;
 b24:	c3                   	ret    
