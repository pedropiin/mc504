 ...
 38c:	89 d1                	mov    %edx,%ecx
{
 ...
 3b9:	0f b6 92 fc 0f 00 00 	movzbl 0xffc(%edx),%edx
 ...
 439:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4a9:	ff 24 85 a4 0f 00 00 	jmp    *0xfa4(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5b7:	90                   	nop
          s = "(null)";
 5b8:	ba 9b 0f 00 00       	mov    $0xf9b,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5d1:	a1 e8 15 00 00       	mov    0x15e8,%eax
{
 ...
 611:	5b                   	pop    %ebx
  freep = p;
 612:	89 15 e8 15 00 00    	mov    %edx,0x15e8
}
 618:	5e                   	pop    %esi
 619:	5f                   	pop    %edi
 61a:	5d                   	pop    %ebp
 ...
 649:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 64c:	89 15 e8 15 00 00    	mov    %edx,0x15e8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 669:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 66c:	8b 3d e8 15 00 00    	mov    0x15e8,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6af:	73 4f                	jae    700 <malloc+0xa0>
    ...
    if(p == freep)
 6b1:	8b 3d e8 15 00 00    	mov    0x15e8,%edi
 ...
 6da:	e8 f1 fe ff ff       	call   5d0 <free>
  return freep;
 6df:	8b 15 e8 15 00 00    	mov    0x15e8,%edx
 ...
 70c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 70f:	89 15 e8 15 00 00    	mov    %edx,0x15e8
}
 ...
 71f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 720:	c7 05 e8 15 00 00 ec 	movl   $0x15ec,0x15e8
 727:	15 00 00 
    base.s.size = 0;
 72a:	bf ec 15 00 00       	mov    $0x15ec,%edi
    base.s.ptr = freep = prevp = &base;
 72f:	c7 05 ec 15 00 00 ec 	movl   $0x15ec,0x15ec
 736:	15 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 739:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 73b:	c7 05 f0 15 00 00 00 	movl   $0x0,0x15f0
 742:	00 00 00 
    if(p->s.size >= nunits){
...
int random()
{
 ...
 a30:	69 0d e4 15 00 00 0d 	imul   $0x19660d,0x15e4,%ecx
 a37:	66 19 00 
 ...
 a5f:	a3 e4 15 00 00       	mov    %eax,0x15e4
    return seed;
 a64:	c3                   	ret    
...
int permute_line(char file_path[]) {
 ...
 c47:	68 10 10 00 00       	push   $0x1010
 c4c:	6a 01                	push   $0x1
 ...
 c60:	68 58 10 00 00       	push   $0x1058
 c65:	6a 01                	push   $0x1
...
int add_line(char *file_path, char *new_line) {
 ...
 d69:	68 94 10 00 00       	push   $0x1094
 d6e:	6a 01                	push   $0x1
 ...
 d82:	68 b8 10 00 00       	push   $0x10b8
 d87:	6a 01                	push   $0x1
...
int write_random_string(char file_path[]) {
 ...
 e00:	be dc 10 00 00       	mov    $0x10dc,%esi
int write_random_string(char file_path[]) {
 e05:	53                   	push   %ebx
        int idx_new_char = random() % size_char_set;
...
void io_bound(char file_path[]) {
 ...
 ecb:	68 34 11 00 00       	push   $0x1134
 ed0:	6a 01                	push   $0x1
