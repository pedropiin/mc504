...
_cpu-bound: formato do arquivo elf32-i386
...
void cpu_bound() {
   ...
   4:	56                   	push   %esi
   5:	53                   	push   %ebx
   6:	8d 84 24 00 90 fd ff 	lea    -0x27000(%esp),%eax
   d:	81 ec 00 10 00 00    	sub    $0x1000,%esp
  13:	83 0c 24 00          	orl    $0x0,(%esp)
  17:	39 c4                	cmp    %eax,%esp
  19:	75 f2                	jne    d <cpu_bound+0xd>
  1b:	81 ec 3c 04 00 00    	sub    $0x43c,%esp
  21:	be e8 03 00 00       	mov    $0x3e8,%esi
  26:	8d bd c4 8b fd ff    	lea    -0x2743c(%ebp),%edi
  2c:	8d 9d e8 8e fd ff    	lea    -0x27118(%ebp),%ebx
  ...
  3b:	8d 85 c0 8b fd ff    	lea    -0x27440(%ebp),%eax
  41:	57                   	push   %edi
  42:	50                   	push   %eax
  43:	53                   	push   %ebx
  44:	e8 d7 08 00 00       	call   920 <gen_random_digraph>

        int dist[MAX_VERT];
        dijkstra(graph, num_vertices, num_edges, 0, dist);
  49:	8d 85 c8 8b fd ff    	lea    -0x27438(%ebp),%eax
  4f:	89 04 24             	mov    %eax,(%esp)
  52:	6a 00                	push   $0x0
  54:	ff b5 c4 8b fd ff    	push   -0x2743c(%ebp)
  5a:	ff b5 c0 8b fd ff    	push   -0x27440(%ebp)
  60:	53                   	push   %ebx
  61:	e8 5a 07 00 00       	call   7c0 <dijkstra>
    for (int i = 0; i < NUM_GRAPHS; i++) {
  66:	83 c4 20             	add    $0x20,%esp
  69:	83 ee 01             	sub    $0x1,%esi
  6c:	75 ca                	jne    38 <cpu_bound+0x38>
    }
  6e:	8d 65 f4             	lea    -0xc(%ebp),%esp
  71:	5b                   	pop    %ebx
  72:	5e                   	pop    %esi
  73:	5f                   	pop    %edi
  74:	5d                   	pop    %ebp
 ...
 38c:	89 d1                	mov    %edx,%ecx
{
 ...
 3b9:	0f b6 92 44 0f 00 00 	movzbl 0xf44(%edx),%edx
 ...
 439:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4a9:	ff 24 85 ec 0e 00 00 	jmp    *0xeec(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5b7:	90                   	nop
          s = "(null)";
 5b8:	ba e4 0e 00 00       	mov    $0xee4,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5d1:	a1 fc 14 00 00       	mov    0x14fc,%eax
{
 ...
 611:	5b                   	pop    %ebx
  freep = p;
 612:	89 15 fc 14 00 00    	mov    %edx,0x14fc
}
 618:	5e                   	pop    %esi
 619:	5f                   	pop    %edi
 61a:	5d                   	pop    %ebp
 ...
 649:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 64c:	89 15 fc 14 00 00    	mov    %edx,0x14fc
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 669:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 66c:	8b 3d fc 14 00 00    	mov    0x14fc,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6af:	73 4f                	jae    700 <malloc+0xa0>
    ...
    if(p == freep)
 6b1:	8b 3d fc 14 00 00    	mov    0x14fc,%edi
 ...
 6da:	e8 f1 fe ff ff       	call   5d0 <free>
  return freep;
 6df:	8b 15 fc 14 00 00    	mov    0x14fc,%edx
 ...
 70c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 70f:	89 15 fc 14 00 00    	mov    %edx,0x14fc
}
 ...
 71f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 720:	c7 05 fc 14 00 00 00 	movl   $0x1500,0x14fc
 727:	15 00 00 
    base.s.size = 0;
 72a:	bf 00 15 00 00       	mov    $0x1500,%edi
    base.s.ptr = freep = prevp = &base;
 72f:	c7 05 00 15 00 00 00 	movl   $0x1500,0x1500
 736:	15 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 739:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 73b:	c7 05 04 15 00 00 00 	movl   $0x0,0x1504
 742:	00 00 00 
    if(p->s.size >= nunits){
...
int random()
{
 ...
 a30:	69 0d f8 14 00 00 0d 	imul   $0x19660d,0x14f8,%ecx
 a37:	66 19 00 
 ...
 a5f:	a3 f8 14 00 00       	mov    %eax,0x14f8
    return seed;
 a64:	c3                   	ret    
...
int add_line(char *file_path, char *new_line) {
 ...
 d82:	68 00 10 00 00       	push   $0x1000
 d87:	6a 01                	push   $0x1
...
int write_random_string(char file_path[]) {
 ...
 e00:	be 24 10 00 00       	mov    $0x1024,%esi
int write_random_string(char file_path[]) {
 e05:	53                   	push   %ebx
        int idx_new_char = random() % size_char_set;
...
void io_bound(char file_path[]) {
 ...
 ecb:	68 7c 10 00 00       	push   $0x107c
 ed0:	6a 01                	push   $0x1
