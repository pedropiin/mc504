 ...
 38c:	89 d1                	mov    %edx,%ecx
{
 ...
 3b9:	0f b6 92 c8 0a 00 00 	movzbl 0xac8(%edx),%edx
 ...
 439:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4a9:	ff 24 85 70 0a 00 00 	jmp    *0xa70(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5b7:	90                   	nop
          s = "(null)";
 5b8:	ba 68 0a 00 00       	mov    $0xa68,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5d1:	a1 38 0e 00 00       	mov    0xe38,%eax
{
 ...
 611:	5b                   	pop    %ebx
  freep = p;
 612:	89 15 38 0e 00 00    	mov    %edx,0xe38
}
 618:	5e                   	pop    %esi
 619:	5f                   	pop    %edi
 61a:	5d                   	pop    %ebp
 ...
 649:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 64c:	89 15 38 0e 00 00    	mov    %edx,0xe38
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 669:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 66c:	8b 3d 38 0e 00 00    	mov    0xe38,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6af:	73 4f                	jae    700 <malloc+0xa0>
    ...
    if(p == freep)
 6b1:	8b 3d 38 0e 00 00    	mov    0xe38,%edi
 ...
 6da:	e8 f1 fe ff ff       	call   5d0 <free>
  return freep;
 6df:	8b 15 38 0e 00 00    	mov    0xe38,%edx
 ...
 70c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 70f:	89 15 38 0e 00 00    	mov    %edx,0xe38
}
 ...
 71f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 720:	c7 05 38 0e 00 00 3c 	movl   $0xe3c,0xe38
 727:	0e 00 00 
    base.s.size = 0;
 72a:	bf 3c 0e 00 00       	mov    $0xe3c,%edi
    base.s.ptr = freep = prevp = &base;
 72f:	c7 05 3c 0e 00 00 3c 	movl   $0xe3c,0xe3c
 736:	0e 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 739:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 73b:	c7 05 40 0e 00 00 00 	movl   $0x0,0xe40
 742:	00 00 00 
    if(p->s.size >= nunits){
...
int random()
{
 ...
 a30:	69 0d 34 0e 00 00 0d 	imul   $0x19660d,0xe34,%ecx
 a37:	66 19 00 
 ...
 a5f:	a3 34 0e 00 00       	mov    %eax,0xe34
    return seed;
 a64:	c3                   	ret    
