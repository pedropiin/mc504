...
00000060 <fmtname>:
{
  ...
  return buf;
      c5:	bb 38 19 00 00       	mov    $0x1938,%ebx
  memset(buf+strlen(p), ' ', DIRSIZ-strlen(p));
      ...
      db:	05 38 19 00 00       	add    $0x1938,%eax
      e0:	52                   	push   %edx
      e1:	6a 20                	push   $0x20
      e3:	50                   	push   %eax
...
00000100 <ls>:
{
  ...
  close(fd);
    ...
    printf(1, "%s %d %d %d\n", fmtname(path), st.type, st.ino, st.size);
     ...
     195:	6a 02                	push   $0x2
     197:	50                   	push   %eax
     198:	68 50 12 00 00       	push   $0x1250
     19d:	6a 01                	push   $0x1
    ...
    *p++ = '/';
    ...
    while(read(fd, &de, sizeof(de)) == sizeof(de)){
     ...
     2a1:	50                   	push   %eax
     2a2:	68 50 12 00 00       	push   $0x1250
     2a7:	6a 01                	push   $0x1
    ...
    printf(2, "ls: cannot open %s\n", path);
     ...
     2c3:	57                   	push   %edi
     2c4:	68 28 12 00 00       	push   $0x1228
     2c9:	6a 02                	push   $0x2
    ...
    return;
     ...
     2e3:	68 5d 12 00 00       	push   $0x125d
     2e8:	6a 01                	push   $0x1
    ...
    printf(2, "ls: cannot stat %s\n", path);
     ...
     303:	57                   	push   %edi
     304:	68 3c 12 00 00       	push   $0x123c
     309:	6a 02                	push   $0x2
    ...
    return;
     ...
     32b:	57                   	push   %edi
     32c:	68 3c 12 00 00       	push   $0x123c
     331:	6a 01                	push   $0x1
     ...
     64c:	89 d1                	mov    %edx,%ecx
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     679:	0f b6 92 d4 12 00 00 	movzbl 0x12d4(%edx),%edx
     ...
     6f9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     769:	ff 24 85 7c 12 00 00 	jmp    *0x127c(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
  ...
  write(fd, &c, 1);
     ...
     877:	90                   	nop
          s = "(null)";
     878:	ba 72 12 00 00       	mov    $0x1272,%edx
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
     891:	a1 48 19 00 00       	mov    0x1948,%eax
{
  ...
  freep = p;
     ...
     8d1:	5b                   	pop    %ebx
  freep = p;
     8d2:	89 15 48 19 00 00    	mov    %edx,0x1948
}
     8d8:	5e                   	pop    %esi
     8d9:	5f                   	pop    %edi
     8da:	5d                   	pop    %ebp
  ...
  freep = p;
     90c:	89 15 48 19 00 00    	mov    %edx,0x1948
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
     92c:	8b 3d 48 19 00 00    	mov    0x1948,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p == freep)
     971:	8b 3d 48 19 00 00    	mov    0x1948,%edi
  ...
  return freep;
     99f:	8b 15 48 19 00 00    	mov    0x1948,%edx
    ...
    if(p->s.size >= nunits){
     ...
     9cc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
     9cf:	89 15 48 19 00 00    	mov    %edx,0x1948
}
     ...
     9df:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
     9e0:	c7 05 48 19 00 00 4c 	movl   $0x194c,0x1948
     9e7:	19 00 00 
    base.s.size = 0;
     9ea:	bf 4c 19 00 00       	mov    $0x194c,%edi
    base.s.ptr = freep = prevp = &base;
     9ef:	c7 05 4c 19 00 00 4c 	movl   $0x194c,0x194c
     9f6:	19 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
     9f9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
     9fb:	c7 05 50 19 00 00 00 	movl   $0x0,0x1950
     a02:	00 00 00 
    if(p->s.size >= nunits){
...
int random()
{
    seed = (seed * 1664525 + 1013904223)%2000000000;
     cf0:	69 0d 34 19 00 00 0d 	imul   $0x19660d,0x1934,%ecx
     cf7:	66 19 00 
     ...
     d1f:	a3 34 19 00 00       	mov    %eax,0x1934
    return seed;
     d24:	c3                   	ret    
...
int permute_line(char file_path[]) {
     ...
     d34:	56                   	push   %esi
     d35:	53                   	push   %ebx
     d36:	81 ec 00 10 00 00    	sub    $0x1000,%esp
     d3c:	83 0c 24 00          	orl    $0x0,(%esp)
     d40:	81 ec 00 10 00 00    	sub    $0x1000,%esp
     d46:	83 0c 24 00          	orl    $0x0,(%esp)
     d4a:	81 ec 64 08 00 00    	sub    $0x864,%esp
    int fp = open(file_path, O_RDONLY);
     d50:	6a 00                	push   $0x0
     d52:	ff 75 08             	push   0x8(%ebp)
     d55:	e8 79 f8 ff ff       	call   5d3 <open>
    if (fp < 0 ) {
     d5a:	83 c4 10             	add    $0x10,%esp
    int fp = open(file_path, O_RDONLY);
     d5d:	89 85 a4 d7 ff ff    	mov    %eax,-0x285c(%ebp)
    if (fp < 0 ) {
     d63:	85 c0                	test   %eax,%eax
     d65:	0f 88 99 01 00 00    	js     f04 <permute_line+0x1d4>
     d6b:	8d b5 10 d8 ff ff    	lea    -0x27f0(%ebp),%esi
    ...
    int line_idx=0;
     d71:	31 db                	xor    %ebx,%ebx
     d73:	89 b5 a0 d7 ff ff    	mov    %esi,-0x2860(%ebp)
    if (fp < 0 ) {
     d79:	89 f7                	mov    %esi,%edi
     d7b:	89 de                	mov    %ebx,%esi
     d7d:	89 c3                	mov    %eax,%ebx
     d7f:	eb 12                	jmp    d93 <permute_line+0x63>
     d81:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi

    // --- Read all lines from the file ---
    while (read(fp, lines[line_idx], STRING_SIZE) > 0 && line_idx < NUM_STRINGS) {
     d88:	83 c7 66             	add    $0x66,%edi
     d8b:	83 fe 64             	cmp    $0x64,%esi
     d8e:	74 16                	je     da6 <permute_line+0x76>
        line_idx++;
     d90:	83 c6 01             	add    $0x1,%esi
    while (read(fp, lines[line_idx], STRING_SIZE) > 0 && line_idx < NUM_STRINGS) {
     d93:	83 ec 04             	sub    $0x4,%esp
     d96:	6a 66                	push   $0x66
     d98:	57                   	push   %edi
     d99:	53                   	push   %ebx
     d9a:	e8 0c f8 ff ff       	call   5ab <read>
     d9f:	83 c4 10             	add    $0x10,%esp
     da2:	85 c0                	test   %eax,%eax
     da4:	7f e2                	jg     d88 <permute_line+0x58>
    }

    // --- Getting random indices representing random strings ---
    int line1 = random() % NUM_STRINGS;
     da6:	89 f3                	mov    %esi,%ebx
     da8:	8b b5 a0 d7 ff ff    	mov    -0x2860(%ebp),%esi
     dae:	e8 3d ff ff ff       	call   cf0 <random>
     db3:	89 c1                	mov    %eax,%ecx
     db5:	b8 1f 85 eb 51       	mov    $0x51eb851f,%eax
     dba:	f7 e9                	imul   %ecx
     dbc:	89 c8                	mov    %ecx,%eax
     dbe:	c1 f8 1f             	sar    $0x1f,%eax
     dc1:	c1 fa 05             	sar    $0x5,%edx
     dc4:	29 c2                	sub    %eax,%edx
     dc6:	6b c2 64             	imul   $0x64,%edx,%eax
     dc9:	29 c1                	sub    %eax,%ecx
     dcb:	89 cf                	mov    %ecx,%edi
    int line2 = random() % NUM_STRINGS;
     dcd:	e8 1e ff ff ff       	call   cf0 <random>
     dd2:	89 c1                	mov    %eax,%ecx
     dd4:	b8 1f 85 eb 51       	mov    $0x51eb851f,%eax
     dd9:	f7 e9                	imul   %ecx
     ddb:	89 c8                	mov    %ecx,%eax
     ddd:	c1 f8 1f             	sar    $0x1f,%eax
     de0:	c1 fa 05             	sar    $0x5,%edx
     de3:	29 c2                	sub    %eax,%edx
     de5:	6b c2 64             	imul   $0x64,%edx,%eax
     de8:	29 c1                	sub    %eax,%ecx

    // --- Swap lines in memory ---
    if (line1 != line2) {
     dea:	39 cf                	cmp    %ecx,%edi
     dec:	89 8d a0 d7 ff ff    	mov    %ecx,-0x2860(%ebp)
     df2:	74 5f                	je     e53 <permute_line+0x123>
        char temp[STRING_SIZE];
        strcpy(temp, lines[line1]);
     df4:	6b c7 66             	imul   $0x66,%edi,%eax
     df7:	8d 8d 10 d8 ff ff    	lea    -0x27f0(%ebp),%ecx
     dfd:	83 ec 08             	sub    $0x8,%esp
     e00:	01 c1                	add    %eax,%ecx
     e02:	8d 85 a8 d7 ff ff    	lea    -0x2858(%ebp),%eax
     e08:	51                   	push   %ecx
     e09:	50                   	push   %eax
     e0a:	89 8d 9c d7 ff ff    	mov    %ecx,-0x2864(%ebp)
     e10:	e8 2b f5 ff ff       	call   340 <strcpy>
        strcpy(lines[line1], lines[line2]);
     e15:	8b 95 a0 d7 ff ff    	mov    -0x2860(%ebp),%edx
     e1b:	8d 85 10 d8 ff ff    	lea    -0x27f0(%ebp),%eax
     e21:	6b d2 66             	imul   $0x66,%edx,%edx
     e24:	01 c2                	add    %eax,%edx
     e26:	58                   	pop    %eax
     e27:	59                   	pop    %ecx
     e28:	8b 8d 9c d7 ff ff    	mov    -0x2864(%ebp),%ecx
     e2e:	52                   	push   %edx
     e2f:	89 95 a0 d7 ff ff    	mov    %edx,-0x2860(%ebp)
     e35:	51                   	push   %ecx
     e36:	e8 05 f5 ff ff       	call   340 <strcpy>
        strcpy(lines[line2], temp);
     e3b:	8b 95 a0 d7 ff ff    	mov    -0x2860(%ebp),%edx
     e41:	5f                   	pop    %edi
     e42:	58                   	pop    %eax
     e43:	8d 85 a8 d7 ff ff    	lea    -0x2858(%ebp),%eax
     e49:	50                   	push   %eax
     e4a:	52                   	push   %edx
     e4b:	e8 f0 f4 ff ff       	call   340 <strcpy>
    ...
    close(fp);  
     ...
     e56:	ff b5 a4 d7 ff ff    	push   -0x285c(%ebp)
     e5c:	e8 5a f7 ff ff       	call   5bb <close>
    fp = open(file_path, O_RDWR);
     e61:	58                   	pop    %eax
     e62:	5a                   	pop    %edx
     e63:	6a 02                	push   $0x2
     e65:	ff 75 08             	push   0x8(%ebp)
     e68:	e8 66 f7 ff ff       	call   5d3 <open>
    ...
    fstat(fp, &st);
     e70:	58                   	pop    %eax
     e71:	8d 85 a8 d7 ff ff    	lea    -0x2858(%ebp),%eax
     e77:	50                   	push   %eax
     e78:	57                   	push   %edi
     e79:	e8 6d f7 ff ff       	call   5eb <fstat>
    char *buffer = malloc(0);
     e7e:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
     e85:	e8 96 fa ff ff       	call   920 <malloc>
    memset(buffer, 0, 0);  
     e8a:	83 c4 0c             	add    $0xc,%esp
     e8d:	6a 00                	push   $0x0
     e8f:	6a 00                	push   $0x0
     e91:	50                   	push   %eax
     e92:	89 85 a4 d7 ff ff    	mov    %eax,-0x285c(%ebp)
     e98:	e8 63 f5 ff ff       	call   400 <memset>
    write(fp, buffer, 0);
     e9d:	8b 95 a4 d7 ff ff    	mov    -0x285c(%ebp),%edx
     ea3:	83 c4 0c             	add    $0xc,%esp
     ea6:	6a 00                	push   $0x0
     ea8:	52                   	push   %edx
     ea9:	57                   	push   %edi
     eaa:	e8 04 f7 ff ff       	call   5b3 <write>
    free(buffer);
     eaf:	8b 95 a4 d7 ff ff    	mov    -0x285c(%ebp),%edx
     eb5:	89 14 24             	mov    %edx,(%esp)
     eb8:	e8 d3 f9 ff ff       	call   890 <free>


    // --- Write the modified content back to the file ---
    if (fp < 0) {
     ebd:	83 c4 10             	add    $0x10,%esp
     ec0:	85 ff                	test   %edi,%edi
     ec2:	78 59                	js     f1d <permute_line+0x1ed>
        printf(1, "Failed to open file for writing in permutation routine.\n");
        return -1;
    }

    for (int i = 0; i < line_idx; i++) {
     ec4:	85 db                	test   %ebx,%ebx
     ec6:	74 26                	je     eee <permute_line+0x1be>
     ec8:	6b db 66             	imul   $0x66,%ebx,%ebx
     ecb:	8d 85 10 d8 ff ff    	lea    -0x27f0(%ebp),%eax
     ed1:	01 c3                	add    %eax,%ebx
     ...
     edd:	56                   	push   %esi
    for (int i = 0; i < line_idx; i++) {
     ede:	83 c6 66             	add    $0x66,%esi
        write(fp, lines[i], STRING_SIZE);
     ee1:	57                   	push   %edi
     ee2:	e8 cc f6 ff ff       	call   5b3 <write>
    for (int i = 0; i < line_idx; i++) {
     ee7:	83 c4 10             	add    $0x10,%esp
     eea:	39 de                	cmp    %ebx,%esi
     eec:	75 ea                	jne    ed8 <permute_line+0x1a8>
    }

    close(fp);
     eee:	83 ec 0c             	sub    $0xc,%esp
     ef1:	57                   	push   %edi
     ef2:	e8 c4 f6 ff ff       	call   5bb <close>
    return 0;
     ef7:	83 c4 10             	add    $0x10,%esp
     efa:	31 c0                	xor    %eax,%eax
     ...
     f03:	c3                   	ret    
        printf(1, "Failed when trying to open file in the permutation routine. Aborting\n");
     f04:	83 ec 08             	sub    $0x8,%esp
     f07:	68 e8 12 00 00       	push   $0x12e8
     f0c:	6a 01                	push   $0x1
     f0e:	e8 dd f7 ff ff       	call   6f0 <printf>
        return -1;
     f13:	83 c4 10             	add    $0x10,%esp
     f16:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
     f1b:	eb df                	jmp    efc <permute_line+0x1cc>
        printf(1, "Failed to open file for writing in permutation routine.\n");
     f1d:	83 ec 08             	sub    $0x8,%esp
     f20:	68 30 13 00 00       	push   $0x1330
     f25:	6a 01                	push   $0x1
     f27:	e8 c4 f7 ff ff       	call   6f0 <printf>
        return -1;
     f2c:	83 c4 10             	add    $0x10,%esp
     f2f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
     f34:	eb c6                	jmp    efc <permute_line+0x1cc>
...
int add_line(char *file_path, char *new_line) {
     ...
     f44:	56                   	push   %esi
     f45:	53                   	push   %ebx
     f46:	81 ec 00 10 00 00    	sub    $0x1000,%esp
     f4c:	83 0c 24 00          	orl    $0x0,(%esp)
     f50:	81 ec 00 10 00 00    	sub    $0x1000,%esp
     f56:	83 0c 24 00          	orl    $0x0,(%esp)
     f5a:	81 ec 04 08 00 00    	sub    $0x804,%esp
    int fp = open(file_path, O_RDONLY);  
     f60:	6a 00                	push   $0x0
     f62:	ff 75 08             	push   0x8(%ebp)
     f65:	e8 69 f6 ff ff       	call   5d3 <open>
    if (fp < 0) {
     f6a:	83 c4 10             	add    $0x10,%esp
     f6d:	85 c0                	test   %eax,%eax
     f6f:	0f 88 b1 00 00 00    	js     1026 <add_line+0xe6>
     f75:	89 c3                	mov    %eax,%ebx
     f77:	8d 85 10 d8 ff ff    	lea    -0x27f0(%ebp),%eax
    ...
    char lines[NUM_STRINGS][STRING_SIZE];
    int line_idx=0;
     f7d:	31 f6                	xor    %esi,%esi
     f7f:	89 85 00 d8 ff ff    	mov    %eax,-0x2800(%ebp)
    if (fp < 0) {
     f85:	89 c7                	mov    %eax,%edi
     f87:	eb 12                	jmp    f9b <add_line+0x5b>
     f89:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi

    // --- Read all lines from the file ---
    while (read(fp, lines[line_idx], STRING_SIZE) > 0 && line_idx < NUM_STRINGS) {
     f90:	83 c7 66             	add    $0x66,%edi
     f93:	83 fe 64             	cmp    $0x64,%esi
     f96:	74 1c                	je     fb4 <add_line+0x74>
        line_idx++;
     f98:	83 c6 01             	add    $0x1,%esi
    while (read(fp, lines[line_idx], STRING_SIZE) > 0 && line_idx < NUM_STRINGS) {
     f9b:	83 ec 04             	sub    $0x4,%esp
     f9e:	89 bd 04 d8 ff ff    	mov    %edi,-0x27fc(%ebp)
     fa4:	6a 66                	push   $0x66
     fa6:	57                   	push   %edi
     fa7:	53                   	push   %ebx
     fa8:	e8 fe f5 ff ff       	call   5ab <read>
     fad:	83 c4 10             	add    $0x10,%esp
     fb0:	85 c0                	test   %eax,%eax
     fb2:	7f dc                	jg     f90 <add_line+0x50>
    }
    close(fp); 
     fb4:	83 ec 0c             	sub    $0xc,%esp
     fb7:	53                   	push   %ebx
     fb8:	e8 fe f5 ff ff       	call   5bb <close>

    // --- Add the new line in memory ---
    strcpy(lines[line_idx], new_line);
     fbd:	58                   	pop    %eax
     fbe:	5a                   	pop    %edx
     fbf:	ff 75 0c             	push   0xc(%ebp)
     fc2:	ff b5 04 d8 ff ff    	push   -0x27fc(%ebp)
     fc8:	e8 73 f3 ff ff       	call   340 <strcpy>
    line_idx++;
    ...
    fp = open(file_path, O_WRONLY);  
     ...
     fce:	5b                   	pop    %ebx
     fcf:	6a 01                	push   $0x1
     fd1:	ff 75 08             	push   0x8(%ebp)
     fd4:	e8 fa f5 ff ff       	call   5d3 <open>
    if (fp < 0) {
    ...
    if (fp < 0) {
     ...
     fe0:	78 5d                	js     103f <add_line+0xff>
     fe2:	6b ce 66             	imul   $0x66,%esi,%ecx
     fe5:	8b 85 00 d8 ff ff    	mov    -0x2800(%ebp),%eax
     feb:	8d 78 66             	lea    0x66(%eax),%edi
     fee:	8d 34 0f             	lea    (%edi,%ecx,1),%esi
     ff1:	eb 08                	jmp    ffb <add_line+0xbb>
     ff3:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
     ff7:	90                   	nop
     ff8:	83 c7 66             	add    $0x66,%edi
    ...
    1000:	50                   	push   %eax
    1001:	53                   	push   %ebx
    1002:	e8 ac f5 ff ff       	call   5b3 <write>
    for (int i = 0; i < line_idx; i++) {
    1007:	89 f8                	mov    %edi,%eax
    1009:	83 c4 10             	add    $0x10,%esp
    100c:	39 f7                	cmp    %esi,%edi
    100e:	75 e8                	jne    ff8 <add_line+0xb8>
    }

    close(fp);
    1010:	83 ec 0c             	sub    $0xc,%esp
    1013:	53                   	push   %ebx
    1014:	e8 a2 f5 ff ff       	call   5bb <close>
    return 0;
    ...
    1029:	68 6c 13 00 00       	push   $0x136c
    102e:	6a 01                	push   $0x1
    1030:	e8 bb f6 ff ff       	call   6f0 <printf>
        return -1;
    1035:	83 c4 10             	add    $0x10,%esp
    1038:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
    103d:	eb df                	jmp    101e <add_line+0xde>
        printf(1, "Failed to open file for writing.\n");
    103f:	83 ec 08             	sub    $0x8,%esp
    1042:	68 90 13 00 00       	push   $0x1390
    1047:	6a 01                	push   $0x1
    1049:	e8 a2 f6 ff ff       	call   6f0 <printf>
        return -1;
    104e:	83 c4 10             	add    $0x10,%esp
    1051:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
    1056:	eb c6                	jmp    101e <add_line+0xde>
    1058:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    105f:	90                   	nop

00001060 <generate_random_string>:
...
void generate_random_string(char s[STRING_SIZE], const char char_set[], const size_t size_char_set) {
    ...
    1069:	8b 5d 08             	mov    0x8(%ebp),%ebx
    106c:	8d 73 64             	lea    0x64(%ebx),%esi
    106f:	89 f7                	mov    %esi,%edi
    1071:	8b 75 0c             	mov    0xc(%ebp),%esi
    1074:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    for (int i = 0; i < (STRING_SIZE - 2); i++) {
        int idx_new_char = random() % size_char_set;
    1078:	e8 73 fc ff ff       	call   cf0 <random>
    107d:	31 d2                	xor    %edx,%edx
    for (int i = 0; i < (STRING_SIZE - 2); i++) {
    107f:	83 c3 01             	add    $0x1,%ebx
        int idx_new_char = random() % size_char_set;
    1082:	f7 75 10             	divl   0x10(%ebp)
        s[i] = char_set[idx_new_char];
    1085:	0f b6 04 16          	movzbl (%esi,%edx,1),%eax
    1089:	88 43 ff             	mov    %al,-0x1(%ebx)
    for (int i = 0; i < (STRING_SIZE - 2); i++) {
    108c:	39 fb                	cmp    %edi,%ebx
    108e:	75 e8                	jne    1078 <generate_random_string+0x18>
    }
    s[STRING_SIZE - 2] = '\n';
    1090:	8b 45 08             	mov    0x8(%ebp),%eax
    1093:	ba 0a 00 00 00       	mov    $0xa,%edx
    1098:	66 89 50 64          	mov    %dx,0x64(%eax)
    s[STRING_SIZE - 1] = '\0';
}
    109c:	83 c4 0c             	add    $0xc,%esp
    109f:	5b                   	pop    %ebx
    10a0:	5e                   	pop    %esi
    10a1:	5f                   	pop    %edi
    10a2:	5d                   	pop    %ebp
    10a3:	c3                   	ret    
    10a4:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    10ab:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    10af:	90                   	nop

000010b0 <write_random_string>:
...
int write_random_string(char file_path[]) {
    ...
    10b1:	b9 15 00 00 00       	mov    $0x15,%ecx
int write_random_string(char file_path[]) {
    10b6:	89 e5                	mov    %esp,%ebp
    10b8:	57                   	push   %edi
    10b9:	56                   	push   %esi
    const char char_set[] = "0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ?'!@#$&*()-+{}[].;,<>:|";
    10ba:	8d bd 2c ff ff ff    	lea    -0xd4(%ebp),%edi
    10c0:	be b4 13 00 00       	mov    $0x13b4,%esi
int write_random_string(char file_path[]) {
    10c5:	53                   	push   %ebx
        int idx_new_char = random() % size_char_set;
    10c6:	bb c1 c0 c0 c0       	mov    $0xc0c0c0c1,%ebx
int write_random_string(char file_path[]) {
    10cb:	81 ec cc 00 00 00    	sub    $0xcc,%esp
    const char char_set[] = "0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ?'!@#$&*()-+{}[].;,<>:|";
    10d1:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
    10d3:	0f b7 06             	movzwl (%esi),%eax
    10d6:	8d 75 e6             	lea    -0x1a(%ebp),%esi
    10d9:	66 89 07             	mov    %ax,(%edi)
    for (int i = 0; i < (STRING_SIZE - 2); i++) {
    10dc:	8d 7d 82             	lea    -0x7e(%ebp),%edi
    10df:	90                   	nop
        int idx_new_char = random() % size_char_set;
    10e0:	e8 0b fc ff ff       	call   cf0 <random>
    for (int i = 0; i < (STRING_SIZE - 2); i++) {
    10e5:	83 c7 01             	add    $0x1,%edi
        int idx_new_char = random() % size_char_set;
    10e8:	89 c1                	mov    %eax,%ecx
    10ea:	f7 e3                	mul    %ebx
    10ec:	c1 ea 06             	shr    $0x6,%edx
    10ef:	6b d2 55             	imul   $0x55,%edx,%edx
    10f2:	29 d1                	sub    %edx,%ecx
        s[i] = char_set[idx_new_char];
    10f4:	0f b6 84 0d 2c ff ff 	movzbl -0xd4(%ebp,%ecx,1),%eax
    10fb:	ff 
    10fc:	88 47 ff             	mov    %al,-0x1(%edi)
    for (int i = 0; i < (STRING_SIZE - 2); i++) {
    10ff:	39 f7                	cmp    %esi,%edi
    1101:	75 dd                	jne    10e0 <write_random_string+0x30>
    s[STRING_SIZE - 2] = '\n';
    1103:	b8 0a 00 00 00       	mov    $0xa,%eax
    ...
    s[STRING_SIZE - 2] = '\n';
    110b:	66 89 45 e6          	mov    %ax,-0x1a(%ebp)
    add_line(file_path, s);
    110f:	8d 45 82             	lea    -0x7e(%ebp),%eax
    1112:	50                   	push   %eax
    1113:	ff 75 08             	push   0x8(%ebp)
    1116:	e8 25 fe ff ff       	call   f40 <add_line>
...
void io_bound(char file_path[]) {
    ...
    1133:	56                   	push   %esi
    1134:	8b 75 08             	mov    0x8(%ebp),%esi
    1137:	53                   	push   %ebx
    1138:	bb 64 00 00 00       	mov    $0x64,%ebx
    ...
    1143:	56                   	push   %esi
    1144:	e8 67 ff ff ff       	call   10b0 <write_random_string>
    for (int i = 0; i < NUM_STRINGS; i++) {
    1149:	83 c4 10             	add    $0x10,%esp
    114c:	83 eb 01             	sub    $0x1,%ebx
    114f:	75 ef                	jne    1140 <io_bound+0x10>
    1151:	bb 32 00 00 00       	mov    $0x32,%ebx
    ...
    1163:	56                   	push   %esi
    1164:	e8 c7 fb ff ff       	call   d30 <permute_line>
    for (int i = 0; i < NUM_PERMUT; i++) {
    1169:	83 c4 10             	add    $0x10,%esp
    116c:	83 eb 01             	sub    $0x1,%ebx
    116f:	75 ef                	jne    1160 <io_bound+0x30>
    }

    if (unlink(file_path) != 0) {
    1171:	83 ec 0c             	sub    $0xc,%esp
    1174:	56                   	push   %esi
    1175:	e8 69 f4 ff ff       	call   5e3 <unlink>
    117a:	83 c4 10             	add    $0x10,%esp
    117d:	85 c0                	test   %eax,%eax
    117f:	75 07                	jne    1188 <io_bound+0x58>
        printf(1,"Error when trying to delete file 'output.txt'\n");
    }
    1181:	8d 65 f8             	lea    -0x8(%ebp),%esp
    1184:	5b                   	pop    %ebx
    1185:	5e                   	pop    %esi
    1186:	5d                   	pop    %ebp
    1187:	c3                   	ret    
    ...
    118b:	68 0c 14 00 00       	push   $0x140c
    1190:	6a 01                	push   $0x1
    1192:	e8 59 f5 ff ff       	call   6f0 <printf>
    1197:	83 c4 10             	add    $0x10,%esp
    119a:	8d 65 f8             	lea    -0x8(%ebp),%esp
    119d:	5b                   	pop    %ebx
    119e:	5e                   	pop    %esi
    119f:	5d                   	pop    %ebp
    11a0:	c3                   	ret    
...
void cpu_bound() {
    ...
    11b4:	56                   	push   %esi
    11b5:	53                   	push   %ebx
    11b6:	8d 84 24 00 90 fd ff 	lea    -0x27000(%esp),%eax
    11bd:	81 ec 00 10 00 00    	sub    $0x1000,%esp
    11c3:	83 0c 24 00          	orl    $0x0,(%esp)
    11c7:	39 c4                	cmp    %eax,%esp
    11c9:	75 f2                	jne    11bd <cpu_bound+0xd>
    11cb:	81 ec 3c 04 00 00    	sub    $0x43c,%esp
    11d1:	be e8 03 00 00       	mov    $0x3e8,%esi
    11d6:	8d bd c4 8b fd ff    	lea    -0x2743c(%ebp),%edi
    11dc:	8d 9d e8 8e fd ff    	lea    -0x27118(%ebp),%ebx
    ...
    11eb:	8d 85 c0 8b fd ff    	lea    -0x27440(%ebp),%eax
    11f1:	57                   	push   %edi
    11f2:	50                   	push   %eax
    11f3:	53                   	push   %ebx
    11f4:	e8 e7 f9 ff ff       	call   be0 <gen_random_digraph>

        int dist[MAX_VERT];
        dijkstra(graph, num_vertices, num_edges, 0, dist);
    11f9:	8d 85 c8 8b fd ff    	lea    -0x27438(%ebp),%eax
    11ff:	89 04 24             	mov    %eax,(%esp)
    1202:	6a 00                	push   $0x0
    1204:	ff b5 c4 8b fd ff    	push   -0x2743c(%ebp)
    120a:	ff b5 c0 8b fd ff    	push   -0x27440(%ebp)
    1210:	53                   	push   %ebx
    1211:	e8 6a f8 ff ff       	call   a80 <dijkstra>
    for (int i = 0; i < NUM_GRAPHS; i++) {
    1216:	83 c4 20             	add    $0x20,%esp
    1219:	83 ee 01             	sub    $0x1,%esi
    121c:	75 ca                	jne    11e8 <cpu_bound+0x38>
    }
    121e:	8d 65 f4             	lea    -0xc(%ebp),%esp
    1221:	5b                   	pop    %ebx
    1222:	5e                   	pop    %esi
    1223:	5f                   	pop    %edi
    1224:	5d                   	pop    %ebp
