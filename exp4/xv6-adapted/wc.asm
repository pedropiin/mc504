  ...
  a6:	31 db                	xor    %ebx,%ebx
{
  ...
  f4:	74 42                	je     138 <wc+0x98>
      if(buf[i] == '\n')
  f6:	0f be 87 c0 0f 00 00 	movsbl 0xfc0(%edi),%eax
        l++;
 ...
 48c:	89 d1                	mov    %edx,%ecx
{
 ...
 4b9:	0f b6 92 00 0c 00 00 	movzbl 0xc00(%edx),%edx
 ...
 539:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5a9:	ff 24 85 a8 0b 00 00 	jmp    *0xba8(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 6b7:	90                   	nop
          s = "(null)";
 6b8:	ba 9f 0b 00 00       	mov    $0xb9f,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6d1:	a1 c0 11 00 00       	mov    0x11c0,%eax
{
 ...
 711:	5b                   	pop    %ebx
  freep = p;
 712:	89 15 c0 11 00 00    	mov    %edx,0x11c0
}
 718:	5e                   	pop    %esi
 719:	5f                   	pop    %edi
 71a:	5d                   	pop    %ebp
 ...
 749:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 74c:	89 15 c0 11 00 00    	mov    %edx,0x11c0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 769:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 76c:	8b 3d c0 11 00 00    	mov    0x11c0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7af:	73 4f                	jae    800 <malloc+0xa0>
    ...
    if(p == freep)
 7b1:	8b 3d c0 11 00 00    	mov    0x11c0,%edi
 ...
 7da:	e8 f1 fe ff ff       	call   6d0 <free>
  return freep;
 7df:	8b 15 c0 11 00 00    	mov    0x11c0,%edx
 ...
 80c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 80f:	89 15 c0 11 00 00    	mov    %edx,0x11c0
}
 ...
 81f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 820:	c7 05 c0 11 00 00 c4 	movl   $0x11c4,0x11c0
 827:	11 00 00 
    base.s.size = 0;
 82a:	bf c4 11 00 00       	mov    $0x11c4,%edi
    base.s.ptr = freep = prevp = &base;
 82f:	c7 05 c4 11 00 00 c4 	movl   $0x11c4,0x11c4
 836:	11 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 839:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 83b:	c7 05 c8 11 00 00 00 	movl   $0x0,0x11c8
 842:	00 00 00 
    if(p->s.size >= nunits){
...
int random()
{
 ...
 b30:	69 0d a4 0f 00 00 0d 	imul   $0x19660d,0xfa4,%ecx
 b37:	66 19 00 
 ...
 b5f:	a3 a4 0f 00 00       	mov    %eax,0xfa4
    return seed;
 b64:	c3                   	ret    
